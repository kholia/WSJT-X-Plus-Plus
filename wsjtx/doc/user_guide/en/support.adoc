...
_WSJT-X Improved_ will be one of these email lists: 
{wsjt-x-improved-community}, or {wsjt_group}. The
...
One of your responsibilities as a _WSJT-X Improved_ user is to help the
volunteer programmers to make the program better.  Bugs may be
reported to one of the email lists mentioned above, preferably to {wsjt-x-improved-community}.
Again, you will need to subscribe to the list.
...
in _WSJT-X Improved_, spell it out in as much detail as seems useful and send
