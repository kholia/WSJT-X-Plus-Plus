...
Packages are available for *64-bit and 32-bit Windows* operating systems that support Windows 7 onwards (7, 8, 10, 11). Download and execute one of the available installation packages for *Windows* following these instructions:
