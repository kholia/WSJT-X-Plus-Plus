...
options available on tabs selectable near the top of the window.
...
of _WSJT-X_, with particular emphasis on the FT8 mode. Most new users
should go through the full HF-oriented tutorial, preferably while at
your operating setup. Subsequent tutorial sections will cover
...
include::band-activity-window.adoc[]
