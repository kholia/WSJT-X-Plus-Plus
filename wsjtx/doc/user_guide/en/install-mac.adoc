...
For *macOS*, packages are available for both *Intel* CPUs (x86_64) and *M-series* CPUs (M1/M2/M3/M4).
The x86_64 installation packages support macOS 10.13 and later. For the M series, zip packages are offered that already contain the complete installation.

Download one of the installation packages to your desktop,
